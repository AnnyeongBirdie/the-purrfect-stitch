...
3. **A JSON educational-content feature is in place.** ✅ **Built 2026-09-08, pending owner content sign-off before commit** (see the review-gate note the sprint prompt required — the 72 questions are presented for review in the session that built this, not committed unilaterally). Once approved this item is fully closed. What shipped:
