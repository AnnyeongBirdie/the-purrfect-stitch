...
| Estelle epilogue — **now the v1 final ending**, not a storybook unlock | 7b / v1 | **designed 2026-09-09** — three acts, beat spec in 7b; five new art assets outstanding |
...
**10. Storybook restructure, and the opening scene becomes mandatory.** Added 2026-09-09, after the code was actually inspected. Not in any earlier version of this phase.
...
4. **Ana's era is playable and the game has an ending.** ⬜ **Open — the ending sprint.** Full detail in Phase 7b above: Ana rendered as the dungeon hero (Daphne's sprite is hardcoded there today — a live inconsistency, not just unbuilt work), her own fairy-magic VFX, the ✨ ability unlocked from the start of her era, the 150/300 → 500/1000 threshold retune, the 3000 마력 ending gate with the now-designed three-act Estelle epilogue, the post-ending free-play state, and — added 2026-09-09 — the storybook restructure that gives every story scene one home and makes the opening scene mandatory on first play. **This is a second sprint alongside the content set, not a tail on the first one** — the owner's call on 2026-09-08, and the hardcoded-sprite finding confirms it.
...
|---|---|---|
| Deposits | 드레스 50냥 · 셔츠 30냥 · 바지 40냥 | `Order.depositAmount`, set at the call site |
| Riddle reward | +15냥 per correct answer, ≤3 per visit | `Riddle.reward` |
...
| Level-up thresholds | 150 / 300 → **500 / 1000** in Phase 7b | `MagicLevelUpThreshold` |
| Ending gate | 3000 마력 | Phase 7b item 6 |
